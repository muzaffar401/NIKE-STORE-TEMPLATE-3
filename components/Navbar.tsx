      ...
      <div className="hidden md:block">
        <div className="top-bar flex flex-col md:flex-row justify-between items-center h-[36px] px-[48px] bg-[#F5F5F5] text-black text-sm">
          ...
          <div className="language space-x-3 flex items-center mt-2 md:mt-0">
            ...
            <span>|</span>
            <span className="items-center cursor-pointer font-semibold"><a href="/login">Sign In</a></span>
          </div>
        </div>
      </div>
          ...
          >
            <div className="p-4">
              ...
              <nav className="space-y-6">
                ...
                <Link href="/login" className="block text-lg hover:text-gray-600">Sign In</Link>
              </nav>
            </div>
          </motion.div>
        )}
